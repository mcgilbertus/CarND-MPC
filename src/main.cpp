...
//            cout << "(" << ptsx_car[i] << "," << ptsy_car[i] << ")" << endl;
          ...
          vector<double> mpc_x_pred;
          vector<double> mpc_y_pred;
          ...
          msgJson["mpc_x"] = mpc_x_pred;
          msgJson["mpc_y"] = mpc_y_pred;

          //Display the waypoints/reference line
          vector<double> next_x_ref;
          vector<double> next_y_ref;
          //.. add (x,y) points to list here, points are in reference to the vehicle's coordinate system
          // the points in the simulator are connected by a Yellow line
          for (double i = 0; i < 100; i += 3) {
            next_x_ref.push_back(i);
            next_y_ref.push_back(polyeval(coeffs, i));
          }
          msgJson["next_x"] = next_x_ref;
          msgJson["next_y"] = next_y_ref;
